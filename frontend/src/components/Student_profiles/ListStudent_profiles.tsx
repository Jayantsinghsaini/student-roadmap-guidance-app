              ...
              >
                ...
                >
                  ...
                  <div className={'flex-1 px-3'}>
                    ...
                    <p className={'line-clamp-2'}>{item.strengths}</p>
                  </div>

                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-500 '}>Weaknesses</p>
                    <p className={'line-clamp-2'}>{item.weaknesses}</p>
                  </div>
                ...
                <ListActionsPopover
                  ...
                  onEdit={onEdit}
                  itemId={item.id}
                  pathEdit={`/student_profiles/student_profiles-edit/?id=${item.id}`}
                  pathView={`/student_profiles/student_profiles-view/?id=${item.id}`}
                  hasUpdatePermission={hasUpdatePermission}
                />
              </div>
            </CardBox>
          ))}
        {!loading && student_profiles.length === 0 && (
...
export default ListStudent_profiles;

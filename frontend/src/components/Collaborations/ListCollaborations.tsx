            ...
            >
              ...
              >
                ...
                <ListActionsPopover
                  ...
                  onEdit={onEdit}
                  itemId={item.id}
                  pathEdit={`/collaborations/collaborations-edit/?id=${item.id}`}
                  pathView={`/collaborations/collaborations-view/?id=${item.id}`}
...
export default ListCollaborations;

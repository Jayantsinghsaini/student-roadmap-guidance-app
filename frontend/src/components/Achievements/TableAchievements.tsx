...
const TableSampleAchievements = ({
  ...
  useEffect(() => {
    if (achievementsNotify.showNotification) {
      notify(
        achievementsNotify.typeNotification,
        achievementsNotify.textNotification,
      );
    }
  ...
  const handleViewAction = (id: string) => {
    router.push(`/achievements/achievements-view/?id=${id}`);
  };

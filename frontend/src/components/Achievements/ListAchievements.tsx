...
const ListAchievements = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_ACHIEVEMENTS');
              ...
              >
                ...
                >
                  ...
                  <div className={'flex-1 px-3'}>
                    ...
                    <p className={'line-clamp-2'}>{item.achievement_name}</p>
                  </div>

                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-500 '}>DateEarned</p>
                    <p className={'line-clamp-2'}>

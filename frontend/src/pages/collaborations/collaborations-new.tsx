...
import { create } from '../../stores/collaborations/collaborationsSlice';
...
CollaborationsNew.getLayout = function getLayout(page: ReactElement) {
  return (
    <LayoutAuthenticated permission={'CREATE_COLLABORATIONS'}>
      {page}
    </LayoutAuthenticated>
  );
};

export default CollaborationsNew;

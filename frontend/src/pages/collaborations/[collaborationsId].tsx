...
const EditCollaborations = () => {
  ...
  const { collaborationsId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: collaborationsId }));
  }, [collaborationsId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: collaborationsId, data }));
...
EditCollaborations.getLayout = function getLayout(page: ReactElement) {
  return (
...
export default EditCollaborations;

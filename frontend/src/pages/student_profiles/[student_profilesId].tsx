...
const EditStudent_profiles = () => {
  ...
  const { student_profilesId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: student_profilesId }));
  }, [student_profilesId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: student_profilesId, data }));
...
EditStudent_profiles.getLayout = function getLayout(page: ReactElement) {
  return (
...
export default EditStudent_profiles;

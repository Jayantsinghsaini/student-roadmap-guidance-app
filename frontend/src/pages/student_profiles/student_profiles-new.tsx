...
import { create } from '../../stores/student_profiles/student_profilesSlice';
...
Student_profilesNew.getLayout = function getLayout(page: ReactElement) {
  return (
    <LayoutAuthenticated permission={'CREATE_STUDENT_PROFILES'}>
      {page}
    </LayoutAuthenticated>
  );
};

export default Student_profilesNew;

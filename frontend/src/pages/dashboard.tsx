...
const Dashboard = () => {
  ...
  const [achievements, setAchievements] = React.useState('Loading...');
  const [collaborations, setCollaborations] = React.useState('Loading...');
  const [resources, setResources] = React.useState('Loading...');
  const [student_profiles, setStudent_profiles] = React.useState('Loading...');
    ...
    <>
      ...
      <SectionMain>
        ...
        <div className='grid grid-cols-1 gap-6 lg:grid-cols-3 mb-6'>
          ...
          {hasPermission(currentUser, 'READ_ACHIEVEMENTS') && (
          ...
          {hasPermission(currentUser, 'READ_COLLABORATIONS') && (
          ...
          {hasPermission(currentUser, 'READ_STUDENT_PROFILES') && (
            <Link href={'/student_profiles/student_profiles-list'}>
              <div
                className={`${
                  corners !== 'rounded-full' ? corners : 'rounded-3xl'
                } dark:bg-dark-900 ${cardsStyle} dark:border-dark-700 p-6`}

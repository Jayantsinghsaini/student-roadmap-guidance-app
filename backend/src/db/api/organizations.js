...
module.exports = class OrganizationsDBApi {
  ...
  static async findBy(where, options) {
    ...
    output.achievements_organization =
      await organizations.getAchievements_organization({
        transaction,
      });

    output.collaborations_organization =
      await organizations.getCollaborations_organization({
        transaction,
      });

    output.resources_organization =
      await organizations.getResources_organization({
        transaction,
      });

    output.student_profiles_organization =
      await organizations.getStudent_profiles_organization({
        transaction,
      });

    output.study_plans_organization =
      await organizations.getStudy_plans_organization({
        transaction,
      });

...
const config = {
  gcloud: {
    bucket: 'fldemo-files',
    hash: '500ad12ac3502c5e995d8c4b7aa7ee3d',
  },
  bcrypt: {
    saltRounds: 12,
  },
  ...
  uploadDir: os.tmpdir(),
  email: {
    from: 'student roadmap guidance app <app@flatlogic.app>',
  ...
  project_uuid: 'b7a14bb5-cced-4e8b-a730-17388b644e20',
  flHost:
...
config.pexelsQuery = 'path to knowledge';
config.host =
